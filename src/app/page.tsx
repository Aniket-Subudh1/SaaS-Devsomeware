...
const Page = () => {
  ...
  muted 
  playsInline
  className="absolute top-0 left-0 -ml-28 md:ml-0 max-w-[600px] sm:max-w-[900px] md:max-w-[1700px] lg:max-w-[2000px]  sm:mt-0 md:mt-0 lg:mt-0 mt-[30px] h-[800px] sm:h-[1200px] lg:h-[1500px] object-fill sm:object-cover md:object-fill lg:object-cover z-0"
>
